...
Функция НайтиКлиентаВ1С(СтруктураПараметров) 
	...
	Если ЗначениеЗаполнено(СтруктураПараметров.IDКлиента) Тогда 
			Контрагент = Обработки.crm_RetailCRMОбработка.УТ11_ВернутьКонтрагентаПоID(Формат(Число(СтруктураПараметров.IDКлиента),"ЧГ="), "customer");
			
			Если Не ЗначениеЗаполнено(Контрагент) Тогда 
				Контрагент = Обработки.crm_RetailCRMОбработка.УТ11_ВернутьКонтрагентаПоТелефону_Почте("", СтруктураПараметров.ТелефонДляПроверки);
				Если Не ЗначениеЗаполнено(Контрагент) Тогда 
