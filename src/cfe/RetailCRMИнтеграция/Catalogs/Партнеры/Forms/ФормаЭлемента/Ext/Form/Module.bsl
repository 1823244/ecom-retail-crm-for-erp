...
Процедура crm_СоздатьКлиентаВCRMПослеНаСервере(Структура)
	...
	Если Объект.ЮрФизЛицо = Перечисления.КомпанияЧастноеЛицо.ЧастноеЛицо Тогда 
		...
		ИДПартнера 	= Обработки.crm_RetailCRMОбработка.УТ11_ПолучитьЗначениеСвойстваОбъекта(Объект.Ссылка, СвойствоПартнеров);
	...
	Иначе 
		...
		Если Объект.ЮрФизЛицо = Перечисления.КомпанияЧастноеЛицо.ЧастноеЛицо Тогда 
			...
			Иначе
				...
				ИДУчастияВПЛ 	= Обработки.crm_RetailCRMОбработка.УТ11_ПолучитьЗначениеСвойстваОбъекта(Объект.Ссылка, СвойствоПартнеров);
				...
				Иначе 
					...
					АктивенВПЛ 	= Обработки.crm_RetailCRMОбработка.УТ11_ПолучитьЗначениеСвойстваОбъекта(Объект.Ссылка, СвойствоПартнеров);
