...
Процедура ВыгрузитьЗаказВCRM(док, Отменить = Ложь) Экспорт
	...
	ИдентифТовара = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ИдентификаторТовара");
	...
	ИспользованиеЗаказов = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ИспользованиеЗаказов");
	Эталонная = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("Эталонная");
	//статус заказа
	СтатусЗаказа = "";
	...
	Если crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ЗагрузкаБроней") = Истина Тогда
...
Процедура CRM_ВыгрузкаТиповЦен() Экспорт
	...
	Если crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ИспользованиеХарактеристик") = Истина Тогда
...
Процедура СоздатьКлиентаИзФормыКонтрагента(Партнер, Успешно, Создать, Обновить) Экспорт 
	...
	КодМагазина    	= СокрЛП(crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("КодМагазина"));
...
Функция АктивироватьКлиентаВПЛ (Партнер, Успешно) Экспорт 
	...
	ИмяСервера    	= СокрЛП(crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ИмяСервера"));;
	КлючCRM    		= СокрЛП(crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("КлючCRM"));
	КодМагазина    	= СокрЛП(crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("КодМагазина"));
...
Процедура ПрописатьИДТоваровИзCRM(Док, ИДЗаказа, ответ)
	...
	ИспользованиеХарактеристик = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ИспользованиеХарактеристик");
	GUIDОрганизации = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("GUIDОрганизации");
...
Функция СоздатьКлиента1С (Структура) Экспорт 
	...
	КонецЕсли;
	Партнер.ГруппаДоступа = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ГруппаДоступаПартнеров");
...
Процедура ВыгрузитьЧекВCRM(док, Отменить = Ложь, ДанныеПЛ = Неопределено, Действие, ДанныеЧека, ИДЗаказа, ФИО) Экспорт
	...
	Если crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ВыгружатьЧек") = Ложь Тогда 
		Возврат;
	КонецЕсли;
	...
	Если Действие <> "ВыгрузитьНовыйЧек" Тогда
		...
		Если док.Партнер = Справочники.Партнеры.РозничныйПокупатель или док.Партнер.Наименование = "Розничный покупатель" Тогда 
			Если crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("ВыгружатьЧекРП") = Ложь Тогда 
				Возврат;
			КонецЕсли;
		Иначе 
			//получим id партнера
	...
	Иначе 
		Если crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("СвязьМагазина") = "Склад1С" Тогда 
			МагазинСклад = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("МагазинСклад");
			...
			КонецЕсли;	
		Иначе
			МагазинОрганизация = crm_RetailCRMОбщий.crm_RetailCRMПовтИсп.ПолучитьЗначениеКонстанты("МагазинОрганизация");
