...
//начало - Елисеев :: 25.11.2023 Была идея отключить этот фрагмент и просто добавлять 
//ЗаказКлиента в ОтложенноеПроведение, но здесь есть метод ПроверитьНаличие(), который
//меняет табл часть Товары - включает там флажок "Отменено", если чего-то не хватает на
//складе.
//todo - возможно метод ПроверитьНаличие() нужно перенести в регл задание
...
//конец - Елисеев :: 25.11.2023	
	...
	//Док.Записать(РежимЗаписиДокумента.Запись);
	//ксп_ИмпортСлужебный.ДобавитьОтложенноеПроведение(Док.Ссылка);
