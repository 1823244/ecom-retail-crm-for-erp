...
Функция УТ11_ВернутьДокументЗаказ (ИД)
	...
	СвойствоЗаказов = crm_RetailCRMОбработка.УТ11_ПолучитьСвойство("ИД", 
...
Процедура УТ11_СоздатьЗаказ(ДанныеЗаказа, стр, искДок, ТЗброни = Неопределено)
	...
	crm_RetailCRMОбработка.УТ11_УстановитьСвойствоУОбъекта(Док.Ссылка, СвойствоЗаказов, ДанныеЗаказа["id"]);  
	crm_RetailCRMОбработка.УТ11_УстановитьСвойствоУОбъекта(Док.Ссылка, СвойствоЗаказовМагазин, ДанныеЗаказа["site"]);
